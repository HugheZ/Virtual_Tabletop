...
class Ui_VTTMainWindow(object):
    def setupUi(self, VTTMainWindow):
        ...
        self.gamesList.setGridSize(QtCore.QSize(150, 150))
    ...
    def retranslateUi(self, VTTMainWindow):
        ...
        self.pushButton.setText(_translate("VTTMainWindow", "↑"))
        ...
        self.actionLog_in_preferences.setText(_translate("VTTMainWindow", "Login preferences..."))
