...
class Ui_Tile(object):
    def setupUi(self, Tile):
        ...
        Tile.resize(150, 150)
        Tile.setMinimumSize(QtCore.QSize(150, 150))
        Tile.setMaximumSize(QtCore.QSize(250, 250))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gameImage.sizePolicy().hasHeightForWidth())
        self.gameImage.setSizePolicy(sizePolicy)
        ...
        self.gameName.setMaximumSize(QtCore.QSize(16777215, 20))
