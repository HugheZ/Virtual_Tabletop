...
class Ui_Tile(object):
    def setupUi(self, Tile):
        ...
        self.gridLayout.addWidget(self.gameName, 0, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.availableLabel, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.localAvailable, 3, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.gameImage, 1, 0, 1, 5)
        self.changeGameActions = QtWidgets.QToolButton(Tile)
        self.changeGameActions.setText("")
        self.changeGameActions.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        self.changeGameActions.setObjectName("changeGameActions")
        self.gridLayout.addWidget(self.changeGameActions, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.cloudAvailable, 3, 3, 1, 1)
